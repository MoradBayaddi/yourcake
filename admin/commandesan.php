...
<body>
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Commandes Annuler</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
    ...
    <tr style="background-color:#fff">
        ...
        <td>      
        <a href="supprimerCmd.php?delete_id=<?php echo $row['idCommande'] ;?>" onclick="return confirm('Voulez vous vraiment supprimer cette Commades ?? !');">
