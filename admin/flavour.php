                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="produit.php">Gestion de produits</a></li>
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-6" >
                                 ...
                                 <div class="col-sm6">
                                     <a href="ajouterFlav.php"  class="btn btn-success" >Ajouter un flaveur</a>
                                    </div>
             ...
             ?>
                            <tbody>
                                <tr>
                                    ...
                                    <th><?php echo $row['id_Flavour'] ;?></th>
                                    <th><?php echo $row['NameFlavour'] ;?></th>
                                    
                                    <td>
                                        
                                        <a href="supprimerFlavour.php?delete_id=<?php echo $row['id_Flavour'] ;?>" onclick="return confirm('Voulez vous vraiment supprimer ce Flavour ?? !');">
