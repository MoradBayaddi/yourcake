                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <!-- <li class="breadcrumb-item"><a href="flavour.php"></a></li> -->
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-6" >
                                 ...
                                 <!-- <div class="col-sm6">
                                     <a href="ajouterFlav.php"  class="btn btn-success" >Ajouter un mada9</a>
                                    </div> -->
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="supprimerMsg.php?msgid=<?php echo $row['id'] ;?>" onclick="return confirm('Voulez vous vraiment supprimer ce Message ?? !');">
