     ...
     include "sidebar.php";
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                $query="SELECT  * FROM `produit` where IdProduct='$idp'";
                ...
                ?>
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <input name="id_p" value="<?php echo $idp; ?>" type="text" class="form-control" readonly required>
                                    </div>
                                    <div class="form-group">
                                        <label for="name">Nom de produit</label>
                                        <input name="nom_p" value="<?php echo $row['ProuductName']; ?>" type="text" class="form-control" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="prix">Prix</label>
                                        <input name="prix" value="<?php echo $row['Prix']; ?>" type="text" class="form-control" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="Description">Description</label>
                                        <input name="desc" value="<?php echo $row['Decription']; ?>" type="text" class="form-control" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="Description_details">Description details</label>
                                        <input name="desc_det" value="<?php echo $row['Description_Details']; ?>" type="text" class="form-control" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="image">Image</label>
                                        <input name="img" value="<?php echo $row['Image_Product']; ?>" type="text" class="form-control" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="image2">Image 2:</label>
                                        <input name="img2" value="<?php echo $row['img2']; ?>" type="text" class="form-control" required>
                                    </div>
                                    <div class="form-group">
        ...
        while($row=mysqli_fetch_array($query_run))
 {
        ...
        ?>
                                    ...
                                    <div class="modal-fooder">
                                        ...
                                        <input type="submit" name="mod" class="btn btn-success" value="Modifier">
                                    </div>
                                </div>
